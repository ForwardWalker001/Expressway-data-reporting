  ...
  <div class="MainContainer">
    ...
    <section class="mainbox">
      ...
      <div class="column column2">
        ...
        <div class="panel pie" style="margin-top: 100px">
          <h2>饼形图-威胁情报类型分布</h2>
          <div class="chart"></div>
          <div class="panel-footer"></div>
        </div>
...
export default {
  ...
  methods: {
    ...
    async init01() {
      ...
      //console.log(myChart);
      /* var map = this.getAllInformation()
      console.log(map) */
      await this.getAllInformation();
      console.log(this.mapData[0][0]);
      var geoCoordMap = {
        上海: [121.4648, 31.2891],
        东莞: [113.8953, 22.901],
        东营: [118.7073, 37.5513],
      ...
      var color = ["#a6c84c", "#ffa022", "#46bee9"]; //箭头线的颜色
      var series = [];
      [
        ["北京", XAData],
        ["西宁", XNData],
