	...
	<div class="unitInfoContainer">
		<el-card class="box-card">
			...
			<div class="serchBox">
				...
				<el-input placeholder="请输入内容" size="mini" v-model="serchData.personPhone">
			...
			<div class="tableContainer">
				...
				<el-table ref="multipleTable" tooltip-effect="dark" style="width: 100%" :data="tableData"
					...
					<el-table-column label="联系人" show-overflow-tooltip prop="personName">
					</el-table-column>
		...
		<!-- 新增对话框 -->
		<el-dialog title="新增硬件资源信息" :visible.sync="addUnitInfoDialogVisible" width="40%" top="50px">
...
<script>
	export default {
		...
		methods: {
			...
			// 搜索
			serchMethod() {
				this.$axios.post("exHardware/findByCondition",{
						...this.serchData
					})
					.then((res) => {
						if (res.data.success) {
