    ...
    <el-card class="box-card">
      ...
      <div class="tableContainer">
        ...
        <el-table ref="multipleTable" tooltip-effect="dark" style="width: 100%">
          ...
          <el-table-column label="系统标识" width="120"> </el-table-column>
          <el-table-column label="系统全称" width="120"> </el-table-column>
          <el-table-column label="系统类型" show-overflow-tooltip>
          </el-table-column>
          <el-table-column label="所属建设单位" show-overflow-tooltip>
          </el-table-column>
